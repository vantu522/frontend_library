                ...
                <li>
                    ...
                    {openSubmenu === 'borrowing' && (
                        ...
                        <li><Link to="/admin/PendingBorrowList" className="px-5 py-2 text-gray-300 hover:text-white">Phiếu Mượn Đang Chờ</Link></li>
                            <li><Link to="/admin/stored-borrows" className="px-5 py-2 text-gray-300 hover:text-white">Danh Sách Phiếu Mượn</Link></li>
                            <li><Link to="/admin/borrowhistory" className="px-5 py-2 text-gray-300 hover:text-white">Lịch Sử Mượn Đã Trả </Link></li>
                            <li><Link to="/admin/RenewHistoryList" className="px-5 py-2 text-gray-300 hover:text-white">Lịch Sử Gia Hạn</Link></li>
                        </ul>
                    )}
                </li>
